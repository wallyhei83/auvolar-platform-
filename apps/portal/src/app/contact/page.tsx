            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200 bg-white p-8">
                ...
                <button
                  ...
                  className="mt-6 flex items-center gap-2 rounded-lg bg-brand px-6 py-3 font-semibold text-black hover:bg-brand-dark disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
