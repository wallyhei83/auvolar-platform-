...
const categories = [
  ...
  { name: 'Stadium Lights', description: 'Sports fields, arenas, venues', image: '/images/products/isf-series-stadium-light.jpg', href: '/products/outdoor/stadium-light', badge: 'New' },
