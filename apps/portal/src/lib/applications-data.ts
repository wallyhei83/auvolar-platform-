...
export const applications: ApplicationData[] = [
  {
    ...
    recommendedProducts: [
      ...
      { name: 'Linear High Bay 220W', sku: 'LHB-220W', wattage: '220W', description: 'Best for racking aisles and narrow spaces', slug: 'linear-high-bay-led-220w' },
  ...
  },
  {
    ...
    recommendedProducts: [
      ...
      { name: 'Linear High Bay 220W', sku: 'LHB-220W', wattage: '220W', description: 'Assembly lines — superior aisle uniformity', slug: 'linear-high-bay-led-220w' },
      { name: 'Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Harsh/wet environments, wash-down areas', slug: 'led-vapor-tight-4ft-40w' },
    ],
    caseStudy: {
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'General retail areas — drop ceiling', slug: 'led-troffer-2x4-50w' },
      { name: 'LED Troffer 2x2 40W', sku: 'TRF-2X2-40W', wattage: '40W', description: 'Checkout areas, smaller spaces', slug: 'led-troffer-2x2-40w' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Modern aesthetic, edge-lit', slug: 'flat-panel-led-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Accent and aisle lighting', slug: '6-led-downlight-15w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Open offices — uniform, low-glare', slug: 'led-troffer-2x4-50w' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Conference rooms, modern aesthetic', slug: 'flat-panel-led-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Lobbies, corridors, break rooms', slug: '6-led-downlight-15w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Area Light 150W', sku: 'AL-150W-T3', wattage: '150W', description: 'Small-medium parking lots, 20ft poles', slug: 'led-area-light-150w-type-iii' },
      { name: 'LED Area Light 300W', sku: 'AL-300W-T3', wattage: '300W', description: 'Large parking lots, 30ft poles', slug: 'led-area-light-300w-type-iii' },
      { name: 'LED Garage Light 100W', sku: 'GAR-100W', wattage: '100W', description: 'Parking garages, covered areas', slug: 'led-garage-light-100w' },
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Canopy Light 40W', sku: 'CN-40W', wattage: '40W', description: 'Small canopies, 2-pump stations', slug: 'led-canopy-light-40w' },
      { name: 'LED Canopy Light 75W', sku: 'CN-75W', wattage: '75W', description: 'Large canopies, 4-8 pump stations', slug: 'led-canopy-light-75w' },
      { name: 'LED Wall Pack 50W', sku: 'WP-50W-5K', wattage: '50W', description: 'Building perimeter and signage', slug: 'led-wall-pack-50w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Classrooms — uniform, flicker-free', slug: 'led-troffer-2x4-50w' },
      ...
      { name: 'LED Wrap Light 4ft 40W', sku: 'WRP-4FT-40W', wattage: '40W', description: 'Corridors and stairwells', slug: 'led-wrap-light-4ft-40w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      ...
      { name: 'LED Flood Light 400W', sku: 'FL-400W', wattage: '400W', description: 'Outdoor fields and courts', slug: 'led-flood-light-400w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Walk-in coolers and freezers', slug: 'led-vapor-tight-4ft-40w' },
      { name: 'LED Vapor Tight 8ft 80W', sku: 'VT-8FT-80W', wattage: '80W', description: 'Large cold storage aisles', slug: 'led-vapor-tight-8ft-80w' },
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Patient rooms, nurse stations', slug: 'led-troffer-2x4-50w' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Exam rooms, modern aesthetic', slug: 'flat-panel-led-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Corridors, waiting rooms', slug: '6-led-downlight-15w' },
    ],
  ...
  // === NEW APPLICATIONS (8 additional) ===
  {
    ...
    recommendedProducts: [
      ...
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Fellowship halls, lobbies', slug: '6-led-downlight-15w' },
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Classrooms, offices', slug: 'led-troffer-2x4-50w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: '4" LED Downlight 10W', sku: 'DL-4IN-10W', wattage: '10W', description: 'Table accent lighting, intimate dining', slug: '4-led-downlight-10w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'General dining areas', slug: '6-led-downlight-15w' },
      { name: 'LED Strip Light 4ft 32W', sku: 'STR-4FT-32W', wattage: '32W', description: 'Kitchen task lighting', slug: 'led-strip-light-4ft-32w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Showroom — high CRI for vehicle display', slug: 'led-troffer-2x4-50w' },
      ...
      { name: 'LED Area Light 300W', sku: 'AL-300W-T3', wattage: '300W', description: 'Outdoor display lots', slug: 'led-area-light-300w-type-iii' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Barns, livestock housing — IP65 sealed', slug: 'led-vapor-tight-4ft-40w' },
      ...
      { name: 'Solar Street Light 60W', sku: 'SOL-ST-60W', wattage: '60W', description: 'Remote areas without power', slug: 'solar-street-light-60w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Government offices', slug: 'led-troffer-2x4-50w' },
      { name: 'LED Area Light 200W', sku: 'AL-200W-T3', wattage: '200W', description: 'Municipal parking and streets', slug: 'led-area-light-200w-type-iii' },
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Building perimeters', slug: 'led-wall-pack-80w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Self-serve bays, vacuum areas', slug: 'led-vapor-tight-4ft-40w' },
      { name: 'LED Vapor Tight 8ft 80W', sku: 'VT-8FT-80W', wattage: '80W', description: 'Wash tunnels, long bays', slug: 'led-vapor-tight-8ft-80w' },
      { name: 'LED Canopy Light 75W', sku: 'CN-75W', wattage: '75W', description: 'Covered entrance/exit canopies', slug: 'led-canopy-light-75w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Interior dock ceiling — weather resistant', slug: 'led-vapor-tight-4ft-40w' },
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Exterior dock face — bright perimeter lighting', slug: 'led-wall-pack-80w' },
      { name: 'LED Flood Light 100W', sku: 'FL-100W', wattage: '100W', description: 'Dock yard — truck maneuvering area', slug: 'led-flood-light-100w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Building perimeter — bright, wide coverage', slug: 'led-wall-pack-80w' },
      { name: 'LED Flood Light 200W', sku: 'FL-200W', wattage: '200W', description: 'Large area security — fences, yards', slug: 'led-flood-light-200w' },
      { name: 'LED Wall Pack 30W', sku: 'WP-30W-5K', wattage: '30W', description: 'Doorways, emergency exits', slug: 'led-wall-pack-30w' },
