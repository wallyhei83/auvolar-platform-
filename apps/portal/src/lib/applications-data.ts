...
export const applications: ApplicationData[] = [
  {
    ...
    recommendedProducts: [
      { name: 'UFO High Bay 100W', sku: 'HB-UFO-100W', wattage: '100W', description: 'Best for 15-20ft ceilings, small warehouses', slug: 'ufo-high-bay-led-light-100w' },
      { name: 'UFO High Bay 150W', sku: 'HB-UFO-150W', wattage: '150W', description: 'Best for 20-25ft ceilings, most warehouses', slug: 'ufo-high-bay-led-light-150w' },
      { name: 'UFO High Bay 200W', sku: 'HB-UFO-200W', wattage: '200W', description: 'Best for 25-30ft ceilings, large facilities', slug: 'ufo-high-bay-led-light-200w' },
      { name: 'Linear High Bay 220W', sku: 'LHB-220W', wattage: '220W', description: 'Best for racking aisles and narrow spaces', slug: 'linear-high-bay-led-light-165w-220w' },
      { name: 'Motion Sensor', sku: 'SENS-HB-MS', wattage: 'N/A', description: 'Occupancy sensor for high bays — 30-50% additional savings', slug: 'motion-sensor-for-ufo-high-bay' },
    ],
    caseStudy: {
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'UFO High Bay 200W', sku: 'HB-UFO-200W', wattage: '200W', description: 'General production areas', slug: 'ufo-high-bay-led-light-200w' },
      { name: 'Linear High Bay 220W', sku: 'LHB-220W', wattage: '220W', description: 'Assembly lines — superior aisle uniformity', slug: 'linear-high-bay-led-light-165w-220w' },
      { name: 'Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Harsh/wet environments, wash-down areas', slug: 'led-vapor-light-4ft-an-vf-series' },
    ],
    caseStudy: {
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'General retail areas — drop ceiling', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'LED Troffer 2x2 40W', sku: 'TRF-2X2-40W', wattage: '40W', description: 'Checkout areas, smaller spaces', slug: 'led-troffer-light-2x2-a-sfp-series' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Modern aesthetic, edge-lit', slug: '2-pack-led-flat-panel-light-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Accent and aisle lighting', slug: '6-led-commercial-downlight-an-dl-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Open offices — uniform, low-glare', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Conference rooms, modern aesthetic', slug: '2-pack-led-flat-panel-light-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Lobbies, corridors, break rooms', slug: '6-led-commercial-downlight-an-dl-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      ...
      { name: 'LED Area Light 300W', sku: 'AL-300W-T3', wattage: '300W', description: 'Large parking lots, 30ft poles', slug: '150w-300w-aera-lighting-shoebox-ot-series' },
      { name: 'LED Garage Light 100W', sku: 'GAR-100W', wattage: '100W', description: 'Parking garages, covered areas', slug: 'led-canopy-garage-light-an-gc-series' },
      { name: 'Photocell', sku: 'SENS-WP-PC', wattage: 'N/A', description: 'Dusk-to-dawn automatic control', slug: 'photocell-sensor-for-wall-packs' },
    ],
    caseStudy: {
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Canopy Light 40W', sku: 'CN-40W', wattage: '40W', description: 'Small canopies, 2-pump stations', slug: 'led-canopy-garage-light-an-gc-series' },
      { name: 'LED Canopy Light 75W', sku: 'CN-75W', wattage: '75W', description: 'Large canopies, 4-8 pump stations', slug: 'led-canopy-garage-light-an-gc-series' },
      { name: 'LED Wall Pack 50W', sku: 'WP-50W-5K', wattage: '50W', description: 'Building perimeter and signage', slug: 'led-wall-pack-light-20w-50w-wsn-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Classrooms — uniform, flicker-free', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'UFO High Bay 150W', sku: 'HB-UFO-150W', wattage: '150W', description: 'Gymnasiums and cafeterias', slug: 'ufo-high-bay-led-light-150w' },
      { name: 'LED Wrap Light 4ft 40W', sku: 'WRP-4FT-40W', wattage: '40W', description: 'Corridors and stairwells', slug: 'led-wrap-light-4ft-an-wr4ft-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'UFO High Bay 240W', sku: 'HB-UFO-240W', wattage: '240W', description: 'Large gymnasiums, 35-50ft ceilings', slug: 'ufo-high-bay-led-light-240w' },
      { name: 'UFO High Bay 200W', sku: 'HB-UFO-200W', wattage: '200W', description: 'Fitness centers, 25-35ft ceilings', slug: 'ufo-high-bay-led-light-200w' },
      { name: 'LED Flood Light 400W', sku: 'FL-400W', wattage: '400W', description: 'Outdoor fields and courts', slug: 'led-flood-light-200w-400w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Walk-in coolers and freezers', slug: 'led-vapor-light-4ft-an-vf-series' },
      { name: 'LED Vapor Tight 8ft 80W', sku: 'VT-8FT-80W', wattage: '80W', description: 'Large cold storage aisles', slug: 'led-vapor-light-8ft-an-vf-series' },
      { name: 'UFO High Bay 150W', sku: 'HB-UFO-150W', wattage: '150W', description: 'High-ceiling cold storage (IP65)', slug: 'ufo-high-bay-led-light-150w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Patient rooms, nurse stations', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'Flat Panel LED 1x4 40W', sku: 'FPL-1X4-40W', wattage: '40W', description: 'Exam rooms, modern aesthetic', slug: '2-pack-led-flat-panel-light-1x4-40w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Corridors, waiting rooms', slug: '6-led-commercial-downlight-an-dl-series' },
    ],
  ...
  // === NEW APPLICATIONS (8 additional) ===
  {
    ...
    recommendedProducts: [
      { name: 'UFO High Bay 150W', sku: 'HB-UFO-150W', wattage: '150W', description: 'High-ceiling sanctuaries', slug: 'ufo-high-bay-led-light-150w' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'Fellowship halls, lobbies', slug: '6-led-commercial-downlight-an-dl-series' },
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Classrooms, offices', slug: 'led-troffer-light-2x4-a-sfp-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: '4" LED Downlight 10W', sku: 'DL-4IN-10W', wattage: '10W', description: 'Table accent lighting, intimate dining', slug: '4-led-commercial-downlight-an-dl4-series' },
      { name: '6" LED Downlight 15W', sku: 'DL-6IN-15W', wattage: '15W', description: 'General dining areas', slug: '6-led-commercial-downlight-an-dl-series' },
      { name: 'LED Strip Light 4ft 32W', sku: 'STR-4FT-32W', wattage: '32W', description: 'Kitchen task lighting', slug: 'led-strip-light-a-ls-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Showroom — high CRI for vehicle display', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'UFO High Bay 200W', sku: 'HB-UFO-200W', wattage: '200W', description: 'Service bays — bright, uniform task lighting', slug: 'ufo-high-bay-led-light-200w' },
      { name: 'LED Area Light 300W', sku: 'AL-300W-T3', wattage: '300W', description: 'Outdoor display lots', slug: '150w-300w-aera-lighting-shoebox-ot-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Barns, livestock housing — IP65 sealed', slug: 'led-vapor-light-4ft-an-vf-series' },
      { name: 'LED Barn Light 70W', sku: 'AN-BL70W', wattage: '70W', description: 'Barn doors, entrances — dusk to dawn', slug: 'led-barn-light-an-bl-series' },
      { name: 'Solar Street Light 60W', sku: 'SOL-ST-60W', wattage: '60W', description: 'Remote areas without power', slug: 'solar-street-light-60w-120w' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Troffer 2x4 50W', sku: 'TRF-2X4-50W', wattage: '50W', description: 'Government offices', slug: 'led-troffer-light-2x4-a-sfp-series' },
      { name: 'LED Area Light 200W', sku: 'AL-200W-T3', wattage: '200W', description: 'Municipal parking and streets', slug: '150w-300w-aera-lighting-shoebox-ot-series' },
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Building perimeters', slug: 'led-wall-pack-80w-120w-wp-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Self-serve bays, vacuum areas', slug: 'led-vapor-light-4ft-an-vf-series' },
      { name: 'LED Vapor Tight 8ft 80W', sku: 'VT-8FT-80W', wattage: '80W', description: 'Wash tunnels, long bays', slug: 'led-vapor-light-8ft-an-vf-series' },
      { name: 'LED Canopy Light 75W', sku: 'CN-75W', wattage: '75W', description: 'Covered entrance/exit canopies', slug: 'led-canopy-garage-light-an-gc-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Vapor Tight 4ft 40W', sku: 'VT-4FT-40W', wattage: '40W', description: 'Interior dock ceiling — weather resistant', slug: 'led-vapor-light-4ft-an-vf-series' },
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Exterior dock face — bright perimeter lighting', slug: 'led-wall-pack-80w-120w-wp-series' },
      { name: 'LED Flood Light 100W', sku: 'FL-100W', wattage: '100W', description: 'Dock yard — truck maneuvering area', slug: 'led-flood-light-50w-200w-fly-series' },
    ],
  ...
  },
  {
    ...
    recommendedProducts: [
      { name: 'LED Wall Pack 80W', sku: 'WP-80W-5K', wattage: '80W', description: 'Building perimeter — bright, wide coverage', slug: 'led-wall-pack-80w-120w-wp-series' },
      { name: 'LED Flood Light 200W', sku: 'FL-200W', wattage: '200W', description: 'Large area security — fences, yards', slug: 'led-flood-light-50w-200w-fly-series' },
      { name: 'LED Wall Pack 30W', sku: 'WP-30W-5K', wattage: '30W', description: 'Doorways, emergency exits', slug: 'led-wall-pack-light-20w-50w-wsn-series' },
      { name: 'Photocell', sku: 'SENS-WP-PC', wattage: 'N/A', description: 'Dusk-to-dawn automatic operation', slug: 'photocell-sensor-for-wall-packs' },
    ],
