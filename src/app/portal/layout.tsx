        ...
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm">
              ...
              <div className="text-gray-500">{session.user.companyName}</div>
            </div>
            <Link
        ...
        <aside className="sticky top-16 h-[calc(100vh-4rem)] w-64 border-r border-gray-200 bg-white">
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <div className="flex flex-col gap-2">
              <Link href="/tools/rfq" className="btn-primary btn-sm text-center">
                Request Quote
              </Link>
              <Link href="/tools/rma" className="btn-outline btn-sm text-center">
                Submit RMA
              </Link>
            </div>
          </div>
