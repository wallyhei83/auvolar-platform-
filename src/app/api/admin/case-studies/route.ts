...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const caseStudy = await prisma.caseStudy.create({
      data: {
        slug, category, title,
        subtitle: subtitle || null, description,
        highlights: highlights || [],
        product: product || null, productSlug: productSlug || null,
        clients: clients || [], location: location || null,
        images: images || [], youtubeId: youtubeId || null,
        stats: stats || [], sortOrder: sortOrder ?? 0,
